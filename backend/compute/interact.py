...
def fetch_edges():
    ...
    # w3 = Web3(Web3.HTTPProvider(f'localhost:8545'))
    ...
    contract_address = '0x35612e5AB65Ad899500E0555D781cA6C986F00E5'#'0x5fbdb2315678afecb367f032d93f642f64180aa3'
    ...
    # contract.functions.addNode(True, "test", "test", "test", 100).transact()

    # contract.functions.addEdge('0x5FbDB2315678afecb367f032d93F642f64180aa3', 100).transact()
